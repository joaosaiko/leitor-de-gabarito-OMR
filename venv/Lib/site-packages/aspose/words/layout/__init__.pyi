...
class RevisionOptions:
    ...
    def insert_cell_color(self) -> aspose.words.layout.RevisionColor:
        """Allows to specify the color to be used for inserted cells :attr:`aspose.words.RevisionType.INSERTION`.
        Default value is :attr:`RevisionColor.BLUE`."""
        ...
    ...
    def delete_cell_color(self) -> aspose.words.layout.RevisionColor:
        """Allows to specify the color to be used for deleted cells :attr:`aspose.words.RevisionType.DELETION`.
        Default value is :attr:`RevisionColor.PINK`."""
        ...
