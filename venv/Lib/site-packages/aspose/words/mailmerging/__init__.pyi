...
class IMailMergeDataSource:
    ...
    def get_value(self, field_name: str, field_value: object) -> bool:
...
class MailMergeCleanupOptions(Enum):
    ...
    and are calculated on the fly (like :attr:`aspose.words.fields.FieldType.FIELD_LIST_NUM`,
    :attr:`aspose.words.fields.FieldType.FIELD_SYMBOL`, etc.) are not considered to be static.
    
    Here is the full list of field types, which are not considered to be static:
    
    * :attr:`aspose.words.fields.FieldType.FIELD_ADVANCE`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_AUTO_NUM`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_AUTO_NUM_LEGAL`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_AUTO_NUM_OUTLINE`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_BARCODE`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_BIDI_OUTLINE`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_DATE`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_DISPLAY_BARCODE`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_MERGE_BARCODE`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_FORM_CHECK_BOX`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_FORM_DROP_DOWN`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_FORMULA`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_GO_TO_BUTTON`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_HYPERLINK`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_INCLUDE_TEXT`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_INDEX_ENTRY`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_LINK`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_LIST_NUM`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_MACRO_BUTTON`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_NOTE_REF`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_NUM_PAGES`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_PAGE`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_PAGE_REF`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_PRINT`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_PRINT_DATE`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_PRIVATE`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_REF_DOC`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_SECTION`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_SECTION_PAGES`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_SYMBOL`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_TIME`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_TOA_ENTRY`
    
    * :attr:`aspose.words.fields.FieldType.FIELD_TOC_ENTRY`"""
    ...
    either the :attr:`MailMergeCleanupOptions.REMOVE_UNUSED_REGIONS` or the :attr:`MailMergeCleanupOptions.REMOVE_EMPTY_TABLE_ROWS` option.
    
    This option applies only to mail merge with regions."""
    REMOVE_EMPTY_TABLES: int
