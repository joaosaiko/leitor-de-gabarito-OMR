...
class FindReplaceOptions:
    ...
    def __init__(self, replacing_callback: aspose.words.replacing.IReplacingCallback):
        ...
        :param replacing_callback: The callback to use for replacing found text."""
        ...
    ...
    def replacement_format(self) -> aspose.words.replacing.ReplacementFormat:
        """Specifies format of the replacement. Default is :attr:`ReplacementFormat.TEXT`.
        
        Has effect only when using in :class:`aspose.words.lowcode.Replacer`"""
        ...
...
class FindReplaceDirection(Enum):
