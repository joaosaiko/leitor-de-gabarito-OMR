...
class OdsoRecipientDataCollection:
    """A typed collection of :class:`OdsoRecipientData`
    To learn more, visit the `Mail Merge and Reporting <https://docs.aspose.com/words/python-net/mail-merge-and-reporting/>` documentation article."""
...
class MailMergeCheckErrors(Enum):
    ...
    """Equals to the :attr:`MailMergeCheckErrors.PAUSE_ON_ERROR` value."""
    DEFAULT: int
    

class MailMergeDataType(Enum):
    ...
    """Equals to :attr:`MailMergeDataType.NONE`."""
    DEFAULT: int
    

class MailMergeDestination(Enum):
    ...
    """Equals to the :attr:`MailMergeDestination.NEW_DOCUMENT` value."""
    DEFAULT: int
...
class MailMergeMainDocumentType(Enum):
    ...
    """Equals to :attr:`MailMergeMainDocumentType.NOT_A_MERGE_DOCUMENT`"""
    DEFAULT: int
    

class MsWordVersion(Enum):
...
class MultiplePagesType(Enum):
    ...
    """Default value is :attr:`MultiplePagesType.NORMAL`"""
    DEFAULT: int
    

class OdsoDataSourceType(Enum):
    ...
    """Equals to :attr:`OdsoDataSourceType.NONE`."""
    DEFAULT: int
    

class OdsoFieldMappingType(Enum):
    ...
    """Equals to :attr:`OdsoFieldMappingType.NULL`."""
    DEFAULT: int
...
class ZoomType(Enum):
    ...
    """Indicates to use the explicit zoom percentage. Same as :attr:`ZoomType.CUSTOM`."""
    NONE: int
